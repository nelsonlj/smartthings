...
metadata {
	definition (
		name: 		"Aeon Home Energy Meter Gen5", 
...
def configure() {
    ...
    secureSequence([
		zwave.configurationV1.configurationSet(parameterNumber: 3, size: 1, scaledConfigurationValue: 0),			// Disable (=0) selective reporting
        zwave.configurationV1.configurationSet(parameterNumber: 101, size: 4, scaledConfigurationValue: 256|512|2048|4096|65536|131072|524288|1048576),
		zwave.configurationV1.configurationSet(parameterNumber: 111, size: 4, scaledConfigurationValue: 10),
